...
export const BulkActionBar: React.FC<BulkActionBarProps> = ({
  ...
  const handleConfirmAction = () => {
    if (showCommentModal === 'approve') {
      ...
      if (!comment.trim()) {
        alert(t('bulkAction.returnCommentRequired'));
        return;
      }
      onReturn(comment);
    } else if (showCommentModal === 'reject') {
      if (!comment.trim()) {
        alert(t('bulkAction.rejectCommentRequired'));
        return;
      }
      onReject(comment);
    }
        ...
        >
          ...
          >
            ...
            <p style={{ margin: '0 0 12px', color: '#6B7280', fontSize: '14px' }}>
              {t('bulkAction.checkpointCount', { count: selectedCount })}
            </p>
            ...
            <div style={{ display: 'flex', gap: '8px', marginTop: '16px', justifyContent: 'flex-end' }}>
              ...
              >
                ...
                {showCommentModal === 'return' && t('bulkAction.return')}
