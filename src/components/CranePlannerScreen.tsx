  ...
  const calculateLiftingCapacity = async (crane: ProjectCrane) => {
    try {
      ...
      for (let i = 0; i < bboxes.length; i++) {
        ...
        let objName = t('crane.object', { index: i + 1 });
        let objWeight = 0;
      ...
      <div style={{ flex: 1, overflow: 'auto', padding: '16px' }}>
                  ...
                  <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '16px' }}>
                    ...
                    <div>
                      ...
                      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: '4px' }}>
                        ...
                        <button onClick={() => moveCrane(-moveStep, moveStep, 0)} style={btnStyle} title="↖">↖</button>
                        <button onClick={() => moveCrane(0, moveStep, 0)} style={btnStyle} title="↑"><FiArrowUp /></button>
                        <button onClick={() => moveCrane(moveStep, moveStep, 0)} style={btnStyle} title="↗">↗</button>
                        {/* Middle row: screen left, center, right */}
                        <button onClick={() => moveCrane(-moveStep, 0, 0)} style={btnStyle} title="←"><FiArrowLeft /></button>
                        ...
                        <button onClick={() => moveCrane(moveStep, 0, 0)} style={btnStyle} title="→"><FiArrowRight /></button>
                        {/* Bottom row: screen down-left, down, down-right */}
                        <button onClick={() => moveCrane(-moveStep, -moveStep, 0)} style={btnStyle} title="↙">↙</button>
                        <button onClick={() => moveCrane(0, -moveStep, 0)} style={btnStyle} title="↓"><FiArrowDown /></button>
                        <button onClick={() => moveCrane(moveStep, -moveStep, 0)} style={btnStyle} title="↘">↘</button>
                      </div>
                    </div>
                    {/* Rotation */}
                ...
                <div style={{ display: 'grid', gridTemplateColumns: 'repeat(2, 1fr)', gap: '16px', marginBottom: '20px' }}>
                  ...
                  <div>
                    ...
                    <input
                      ...
                      placeholder={t('crane.positionLabelPlaceholder')}
                    />
                  </div>
              ...
              <div style={{
                ...
                <div>
                  ...
                  <p style={{ margin: '4px 0 0 0', fontSize: '12px', color: '#6b7280' }}>
                    {liftingModal.crane.position_label || t('crane.unnamed')} • {liftingModal.crane.crane_model?.manufacturer} {liftingModal.crane.crane_model?.model}
                  </p>
                </div>
                <button
        ...
        {previewLoading && (
          <div style={{
            ...
            <span style={{ fontSize: '14px', fontWeight: 500 }}>{t('crane.updating')}</span>
          </div>
        )}
      </div>
    </div>
